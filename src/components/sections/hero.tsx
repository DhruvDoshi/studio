...
export function Hero() {
  return (
    <section className="relative bg-brand-navy py-24 sm:py-32 lg:py-40">
      <div className="absolute inset-0 bg-gradient-to-br from-brand-teal/10 via-brand-navy to-brand-navy/95"></div>
      <div className="container mx-auto px-4 md:px-6 text-center relative">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Button asChild size="lg" className="bg-brand-teal hover:bg-brand-teal/90 text-white shadow-lg">
