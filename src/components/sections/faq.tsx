...
export function Faq() {
  return (
    <section id="faq" className="py-20 md:py-28 bg-brand-navy">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, index) => (
              <AccordionItem value={`item-${index}`} key={index} className="border-brand-teal/30">
                <AccordionTrigger className="text-left font-semibold text-white hover:text-brand-teal">{faq.question}</AccordionTrigger>
