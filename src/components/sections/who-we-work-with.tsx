...
export function WhoWeWorkWith() {
  return (
    <section id="who-we-dont-work-with" className="py-20 md:py-28 bg-gray-50">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <Card className="bg-white border-red-200 shadow-lg">
              <CardHeader>
                 <CardTitle className="font-headline text-xl text-brand-navy">We're not the right fit if you're:</CardTitle>
              </CardHeader>
              <CardContent>
